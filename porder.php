...
<h4 class="m-2 font-weight-bold text-primary">Purchase Order</h4> <br>
<form name="myform" class="form-group" action="saveporder.php?action=add" method="POST">
	<div class="row">
	<div class="col-md-3">
	<?php
     echo $sup; 
	...
	<input type="text" class="form-control" placeholder="Order No" name="ono" required>
	</div>
	<div class="col-md-3">
	<label for ="odate">Order Date</label>
	<input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" placeholder="Order Date" name="odate" required>
	</div>
	<div class="col-md-3">
