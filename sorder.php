...
<h4 class="m-2 font-weight-bold text-primary">Sales Order</h4> <br>
<form name="myform" class="form-group" action="savesorder.php?action=add" method="POST">
	<div class="row">
	<div class="col-md-3">
	<?php
     echo $cus; 
	...
	<input type="text" class="form-control" placeholder="Order No" name="ono">
	</div>
	<div class="col-md-3">
