...
<h4 class="m-2 font-weight-bold text-primary">Purchase Return
<a href="#" data-toggle="modal" data-target="#aModal" class="btn btn-info" role="button" style="float: right;">Add Product</a></h4> <br>
<form name="myform" class="form-group" action="savepreturn.php?action=add" method="POST">
	<div class="row">
	<div class="col-md-3">
	<?php
     echo $sup; 
	...
	<div class="row">
	<div class="col-md-3">
	<label for ="rno">Return No</label>
	<input type="text" class="form-control" placeholder="Return Order No" name="rno">
	</div>
	<div class="col-md-3">
	<label for ="ddate">Return Date</label>
	<input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" placeholder="Return Date" name="rdate" required>
	</div>
	<div class="col-md-3">
	<label for ="bno">Billing No</label>
	<input type="text" class="form-control" placeholder="Billing No" name="bno">
	</div>
	<div class="col-md-3">
	<label for ="bdate">Billing Date</label>
	<input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" placeholder="Billing Date" name="bdate" >
	</div>
	<div class="col-md-3">
