...
$sql2 = "SELECT DISTINCT CUST_ID, full_name FROM customer order by full_name asc";
...
<form name="myform" class="form-group" action="savesales.php?action=add" method="POST">
	<div class="row">
	<div class="col-md-3">
		<?php
     echo $cus; 
?>
	...
	<div class="col-md-3">
	<!--<label for ="Purchase">Po No</label>-->
	...
	<input type="text" class="form-control" placeholder="Invoice No" name="ino">
	</div>
	</div>
	<div class="row">
	<div class="col-md-3">
	<label for ="Invoicedate">Invoice Date</label>
	<input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" placeholder="Po Date" name="idate" >
	</div>
	<div class="col-md-3">
	<label for="Pterms">Payment Terms</label>
	<select class="form-control" name="pterms">
	...
	<input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" placeholder="Po Date" name="ddate" >
		</div>
	</div>
	<div class="row">
	<div class="col-md-3">
      ...
      <table class="content-table" id="tab_logic">
        ...
        <tbody>
          <tr id='addr0'>
			...
			<td "text-align:center"><input type="text" name='serial[]' placeholder='Enter Serial No' class="form-control serial" style="text-align: center;" required/></td>
